 ...
 * //do not use
 */
public class AutoMetroLayout extends ViewGroup
{
    ...
    public AutoMetroLayout( Context context, AttributeSet attrs)
    {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AutoMetroLayout );
        mDivider = a.getDimensionPixelOffset(R.styleable.AutoMetroLayout_metro_divider , 0);
