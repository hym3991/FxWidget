package com.neo.widget_core.autolayout.config;
...
import com.neo.widget_core.autolayout.utils.AutoUtils;
import com.neo.widget_core.autolayout.utils.L;
import com.neo.widget_core.autolayout.utils.ScreenUtils;
...
public class AutoLayoutConifg {
    ...
    public void init( Context context) {
        ...
        //取宽度作为基准
        float design = 1.0f * mDesignHeight / mDesignWidth;
        float screen = 1.0f * screenSize[1] / screenSize[0];
        if (screen > design) {
            mScreenHeight = (int) (mScreenWidth * design);
        }else{
            mScreenHeight = screenSize[1];
        }
    ...
    private void getMetaData( Context context) {
        screenOriatation = AutoUtils.getScreenOriatation(context);
